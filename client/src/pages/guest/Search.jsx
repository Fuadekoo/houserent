        ...
        <div>
            ...
            <div className='flex flex-col md:flex-row'>
                    ...
                    <form onSubmit={handleSubmit} className='flex flex-col gap-4'>
                        <div className="flex items-center gap-2">
                            ...
                            <input type="text" id='searchTerm'   
                                placeholder='Search ...' className='border rounded-lg p-3 w-full'
                        ...
                        <div className="flex gap-2 flex-wrap items-center">
                            ...
                            <select
                                id="housecategory"
                                value={sidebardata.housecategory}
                                onChange={handleChange}
                        ...
                        <div className="flex gap-2 flex-wrap items-center">
                            ...
                            <div className="flex gap-2">
                                <input type="checkbox" id='parking' className='w-s'
                                    onChange={handleChange}
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            >
                                <option value='rentPerMonth_desc'>Price high to low</option>
                                <option value='rentPerMonth_asc'>Price low to high</option>
                ...
                <div className="flex-1">
                    ...
                    {showMore && (
                        <button onClick={onShowMoreClick} className='bg-slate-700 text-white p-3 rounded-lg w-full hover:opacity-95'>Show More</button>
                    )}
                </div>
            </div>
        </div>
